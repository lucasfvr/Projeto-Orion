    ...
    return (
        <>
            <Navbar expand="xxl" fixed="top" variant="dark" className="p-2">
                <Container fluid>
                    <Navbar.Brand href="#" className="fs-1 text">
                    ...
                    <div className="d-none d-xxl-block">
                        <Form className="d-flex align-items-center">
                            ...
                            <NavDropdown
                                className="perfilnav"
                                title={<Image src={profileIcon} alt="Perfil" width="60" height="60" roundedCircle className="ms-2" />}
                    ...
                    <Navbar.Toggle aria-controls="offcanvasNavbar" className="d-xxl-none" />
            ...
            <Modal show={showLogoutModal} onHide={handleCloseLogoutModal} centered>
                ...
                <Modal.Body>Já vai? A masmorra final ainda nem foi explorada! Tem certeza que quer sair??</Modal.Body>
                <Modal.Footer>
